...
export function ValueFrame({ title, content, imgPath }: ValueFrameProps) {
  return (
    <div className="flex flex-col w-full md:w-[30%] lg:w-[25vh] items-center text-center">
      <h1 className="text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-3xl font-bold">
        {title}
      </h1>
      <p className="whitespace-pre text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg px-2 md:px-3 mt-1 md:mt-2">
        {content}
      </p>
      <div
        className="mt-1 md:mt-2 h-0 w-0"
        style={{
